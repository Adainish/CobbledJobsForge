...
public class TextUtil
{
    ...
    private static final MutableComponent PLUGIN_PREFIX = Component.literal(Util.formattedString(CobbledJobsForge.languageConfig.prefix)).setStyle(Style.EMPTY.withColor(BLUE));

    private static final MutableComponent MESSAGE_PREFIX = getPluginPrefix().append(Component.literal(CobbledJobsForge.languageConfig.splitter).setStyle(Style.EMPTY.withColor(ORANGE)));
